...
pub fn auto_assign(
  ...
  unreachable!(
    "`#[auto_assign]` macro should not be imported. It is consumed by the \
     `#[impl_state]` macro."
  );
}
...
pub fn require(
  ...
  unreachable!(
    "`#[require]` macro should not be imported. It is consumed by the \
     `#[impl_state]` macro."
  );
}
...
pub fn switch_to(
  ...
  unreachable!(
    "`#[switch_to]` macro should not be imported. It is consumed by the \
     `#[impl_state]` macro."
  );
}
